...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 6.736;
        public double lateralInPerTick = inPerTick;
        public double trackWidthTicks = 733.2205839465084;

        // feedforward parameters (in tick units)
        public double kS = 1.4666248834327114;
        public double kV = 0.004028448353134105;
        public double kA = 0;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront.setDirection(DcMotor.Direction.REVERSE); //Set Directions
